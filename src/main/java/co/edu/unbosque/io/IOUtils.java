...
public class IOUtils {
     ...
     * @param limt  the number of bytes to read as much
     * @return the requested byte array
     * @throws NullPointerException if the input is null
     * @throws IOException if an I/O error occurs
     */
    public static byte[] toByteArray(InputStream input,long limit) throws IOException {
     ...
     * @since Commons IO 1.1
     */
    public static int copy(InputStream input, OutputStream output,long limit) throws IOException {
    ...
    public static long copyLarge(InputStream input, OutputStream output)
            throws IOException {
        return copyLargeLimited(input, output, -1);
    }
    
    public static long copyLarge(InputStream input, OutputStream output,long limit) throws IOException{
        return copyLargeLimited(input, output, limit);
    }
    
        /**
     * Copy bytes from a large (over 2GB) <code>InputStream</code> to an
     * <code>OutputStream</code> until the specified limit.
     * <p>
     * This method buffers the input internally, so there is no need to use a
     * <code>BufferedInputStream</code>.
     * 
     * @param input  the <code>InputStream</code> to read from
     * @param output  the <code>OutputStream</code> to write to
     * @param limit  the buffer limit to process
     * @return the number of bytes copied
     * @throws NullPointerException if the input or output is null
     * @throws IOException if an I/O error occurs
     * @since Commons IO 1.3
     */
    public static long copyLargeLimited(InputStream input, OutputStream output,long limit)
            throws IOException {
